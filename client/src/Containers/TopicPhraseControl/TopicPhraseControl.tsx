...
function TopicPhraseControl () {
	...
	if(addNewPhrase) {
		return <CardTemplate user="moderator" content={<ModAddPhrase handleAddNewPhrase={handleAddNewPhrase}/>} />;
	} else {
		return <CardTemplate user="moderator" content={<ModAddTopic handleAddNewPhrase={handleAddNewPhrase}/>} />;
	}
}
